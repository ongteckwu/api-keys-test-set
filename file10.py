...
class MockOAuthDataStore(oauth.OAuthDataStore):
    ...
    def __init__(self):
        ...
        self.request_token = "PP0PY1XRTPCUWR0RHXKPUE1DD2T8DYETWMYX8K2UKYECYTCHU2UPEX2W5UUUXW152RMXXETKKPCUW"
        self.access_token = "SW0Bh1u7qBWheSsqhDpywRe0wAlLELux9eZ7lKkuuGxjhTJ8TU5Jbt2zBxkD8cr6YoLbX9"
        self.nonce = 'nonce'
